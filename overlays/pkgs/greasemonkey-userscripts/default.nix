...
in
{
  ...
  twitter-direct = mkGreasemonkeyScript {
    ...
    hash = "sha256-Zdj9ICaJ7867QhOA94QgrlEY7TJ+tIDwmfeJPZcO9wM=";
  };
  ...
  speed-up-google-captcha = mkGreasemonkeyScript {
    ...
    hash = "sha256-jqTGqo/XlwXCtroVqsnkVsWhAujt4gISiQrxlJw/4qs=";
  };
  ...
  imdb-full-summary = mkGreasemonkeyScript {
    ...
    hash = "sha256-9fOzfDsUAlrtM9c0RAKqGdRears3oDkveqk3+hVZ1HQ=";
  };
